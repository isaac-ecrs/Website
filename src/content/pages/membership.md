...
hero:
  title: Become a Member of ECRS
  subtitle: Join our community of play and creativity
intro: |
...
pricingTiers:
  - name: Annual - Single
    price: $25
    duration: per year
    description: Individual membership for one year
  - name: Annual - Additional Household
    price: $15
    duration: per year
    description: For additional members over 16 in the same household
  - name: Lifetime - Individual
    price: $400
    duration: one-time
    description: Never pay dues again as an individual member
    highlighted: true
  - name: Lifetime - Couple
    price: $650
    duration: one-time
    description: Lifetime membership for two people in the same household
formPlaceholderId: cognito-membership-form
tagline: Come grow with us in body, mind, and spirit
---
